...
and PersistentCheckpointBackend (PostgreSQL-backed).
...
class TestPersistentCheckpointBackend:
    """Tests for PostgreSQL-backed persistent checkpoint storage."""
    ...
    def test_persistent_save_and_load(self):
        """Save checkpoint to database, load it back, verify fidelity."""
    ...
    def test_persistent_table_creation(self):
        """Backend can be created and used with an empty database."""
        backend = PersistentCheckpointBackend()
