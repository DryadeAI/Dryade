...
Uses a per-test PostgreSQL test database for isolation.
"""
...
@pytest.fixture
def registry():
    """Create a FactoryRegistry backed by a PostgreSQL test database.

    Truncates all factory tables before each test to ensure isolation.
    """
    ...
    # Truncate factory tables to ensure test isolation
    _factory_tables = [
        "suggestion_log",
        "escalation_history",
        "relevance_signals",
