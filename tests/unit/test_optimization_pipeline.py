...
class TestSynthesizeMessage:
    def test_self_improve(self):
        result = _synthesize_message("self_improve", "abc")
    ...
    def test_create_tool(self):
        result = _synthesize_message("create_tool", "xyz")
        assert isinstance(result, str)
        assert len(result) > 0
        assert "{" not in result
    ...
    def test_deterministic(self):
        ...
        r1 = _synthesize_message("self_improve", "abc")
        r2 = _synthesize_message("self_improve", "abc")
        assert r1 == r2

    def test_different_hashes_may_differ(self):
        """Different hashes can produce different messages."""
        r1 = _synthesize_message("self_improve", "aaa")
        r2 = _synthesize_message("self_improve", "zzz")
