...
class TestMetaActionPatterns:
    ...
    def test_system_prompt_has_meta_action_guidance(self):
        ...
        # Rule 7 for system management (Phase 167: updated wording)
        assert "create" in ORCHESTRATE_SYSTEM_PROMPT.lower()
        assert "modify_config" in ORCHESTRATE_SYSTEM_PROMPT
...
class TestMetaActionInterception:
    ...
    async def test_meta_action_registers_pending_escalation(self):
        ...
        # Post-119.6: ComplexHandler uses FACTORY_CREATE instead of CREATE_AGENT
    ...
    async def test_meta_action_escalation_contains_original_message(self):
        ...
        # Post-119.6: FACTORY_CREATE uses "goal" key (not "task_description")
